...
<form action="" method="post" style="margin-top:20px;margin-right:20px;">
	<div style="height:500px;padding:20px;overflow:auto;" class="ui-widget ui-widget-content ui-corner-all">
		<label for="css_text" style="font-size:12px;">Here you can edit the coverflow main CSS file (css/fwds3dcov.css):</label>
	  	<br><br>
	...
	<?php wp_nonce_field("fwds3dcov_css_editor_update", "fwds3dcov_css_editor_nonce"); ?>
</form>
