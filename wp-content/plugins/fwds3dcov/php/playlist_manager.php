...
<div id="add-thumbnail-dialog" title="Add new thumbnail">
	...
	<fieldset>
		...
		<img src=<?php echo $this->_dir_url . "load/icons/help-icon.png" ?> style="vertical-align:middle;margin-left:4px;"
			title="This option sets the thumbnail click action. If 'none' it won't do anything on click. If 'link' it will open the URL that can have the _blank or _self target.
				If 'media' it will open the URL in the lightbox, which can be an image path, a Youtube video or a Vimeo video URL. If 'iframe' it will open the URL in the lightbox in an iframe.">
...
<form action="" method="post" style="margin-top:20px;margin-right:20px;">
	...
	<?php wp_nonce_field("fwds3dcov_playlist_manager_update", "fwds3dcov_playlist_manager_nonce"); ?>
</form>
