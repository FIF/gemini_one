		...
		<div id="top-bar" class="clearfix">
			...
			<div class="top-inner">
				...
				<ul class="top-menu fr">
					...
					<li id="menu-item-122" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-122"><a href="<?php get_site_url(); ?>/register">Profile</a><span>/</span></li>
					<?php } else { ?>
					<li id="menu-item-123" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-123"><a href="<?php get_site_url(); ?>/login">Đăng nhập</a><span>/</span></li>
					<li id="menu-item-122" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-122"><a href="<?php get_site_url(); ?>/register">Đăng ký</a><span>/</span></li>
					<?php } ?>
				</ul>
